...
def ConditionFixedPointRoot(out: tuple) -> jnp.ndarray:
    """ Conditions for continuation of while loop
            ...
            - Output: (jnp.ndarray): array containing a boolean (true/false)
...
def ConditionSQUAREM(out: tuple) -> jnp.ndarray:
    """ Conditions for continuation of while loop
...
def FixedPointRoot(fun: Callable,
    ...
    if acceleration == "None":
        ...
        def funFXP(x):
            return UpdateFixedPointRoot(x,fun)
